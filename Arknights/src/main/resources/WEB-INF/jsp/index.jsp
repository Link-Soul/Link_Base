...
<head>
    ...
    <link rel="card" type="text/css" href="<c:url value="/static/css/card.css"/>">
    <%--    没用上--%>
    <style type="text/css">
        #mask {
            position: fixed;
...
<body onload="onLoad()">
<div id="mask" align="center">数据查询中，请稍后</div>
...
<div id="app">
    ...
    <div style="width: 70%;float: left">
        ...
        <button id="getNumByPoolChartChangeF" onclick="change(false)" hidden="hidden">点击切换为总抽数</button>
        <button id="resetTotalMessageTable" onclick="changeTotalMessageTable()">重置数据</button>
        <%--    <button id="resetTotalMessageTable2" onclick="changeTotalMessageTable2()">测试遮罩层</button>
            <button id="resetTotalMessageTable3" onclick="changeTotalMessageTable3()">测试遮罩层</button>--%>
