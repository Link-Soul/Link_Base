...
//    String file = "D:\\FFOutput\\明天下午三点开会.mp3";
    String file = "D:\\FFOutput\\下午一点闹钟.mp3";
...
//                        System.out.println(LocalDateTime.now().format(DateTimeFormatter.ofPattern("yyyy-MM-dd HH:mm.ss.SSS")) + " 【5】asr结果输出结束，输出内容为： " + stringBuilder.toString());
            ...
            public void onClose(int code, String reason, boolean remote) {
                System.out.println(LocalDateTime.now().format(DateTimeFormatter.ofPattern("yyyy-MM-dd HH:mm.ss.SSS")) + " 【6】 线程【"+Thread.currentThread().getName()+"】websocket连接已关闭。 ");
            }
        ...
        client.addHeader("Authorization", "1");
        client.connect();
