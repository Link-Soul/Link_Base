...
//    private static final String WS_URL = "ws://tree.kaerplatform.com/ai/ws/asr-nlp/stream"; // 替换为实际的 WebSocket 地址
    ...
    int BUFFER_SIZE = 1024 * 64; // 每次读取的块大小，可根据需要调整
    //    String file = "D:\\FFOutput\\orange.amr";
//    String file = "D:\\FFOutput\\标准录音 18.mp3";
//    String file = "D:\\FFOutput\\昨天三点.mp3";
//    String file = "D:\\FFOutput\\标准录音 17~1.wav";
//    String file = "D:\\FFOutput\\明天21点.mp3";
//    String file = "D:\\FFOutput\\test.amr";
//    String file = "D:\\FFOutput\\test~2.mp3";
//    String file = "D:/FFOutput/asr+nlp闹钟测试/一分钟后.wav";
//    String file = "D:/FFOutput/asr+nlp闹钟测试/周天下午四点锻炼.wav";
//    String file = "D:/FFOutput/asr+nlp闹钟测试/一分钟后.wav";
//    String file = "D:/FFOutput/asr+nlp闹钟测试/一分钟后.wav";
//    String file = "D:/FFOutput/描述春天的古诗词(1).wav";
//    String file = "D:/FFOutput/test2(1).pcm";
//    String file = "D:/FFOutput/test.mp3";

//    String file = "D:/FFOutput/测试用例/帮我写一首关于夏天的诗.mp3";
//    String file = "D:/FFOutput/测试用例/介绍一下李白.mp3";
//    String file = "D:/FFOutput/测试用例/他有什么著作.mp3";
//    String type = "mp3";
//    String model = "huoshan";

//    String file = "D:/FFOutput/测试用例/文章.wav";
//    String file = "D:/FFOutput/测试用例/AI大模型.wav";
//    String file = "D:/FFOutput/测试用例/帮我写一首关于夏天的诗.wav";
    String file = "D:/FFOutput/测试用例/真是难受、最近好累啊.wav";
//    String file = "D:/FFOutput/测试用例/法轮功.mp3";
//    String file = "D:/FFOutput/测试用例/法轮功.wav";
//    String file = "D:/FFOutput/测试用例/十年.mp3";
//    String file = "D:/FFOutput/测试用例/电台.mp3";
//    String file = "D:/FFOutput/测试用例/大点声音.mp3";

//    String file = "D:/FFOutput/test_voices/07b2b5e9931443bd9f620df281b9d5c8.mp3";
    //小点动静
//    String file = "D:/FFOutput/test_voices/d4c253a85c2b4456892c5fa4be97895a.mp3";
//    String file = "D:/FFOutput/test_voices/17bff1731b86492db110cf7781b24f54.mp3";
//    String file = "D:/FFOutput/test_voices/d7da57d9615e4857a85971447ab9f0c0.mp3";


    String type = "wav";
    static String model = "huoshan";
//            private static final Integer nlp = NlpEnum.AI_ALARM.getNlp(); // 使用的模型能力
    private static final Integer nlp = NlpEnum.AI_TREE_HOLE_ASSISTANT.getNlp(); // 使用的模型能力
        ...
        WebSocketClient client = new WebSocketClient(new URI(WS_URL)) {
            ...
            public void onOpen(ServerHandshake handshakedata) {
                ...
                try (FileInputStream fis = new FileInputStream(file)) {
                    ...
                    reqBodyone.put("model", model);
                    JSONObject content = new JSONObject();

                    content.put("serial_number","865443040229664");
                    content.put("type","2");

//                    content.put("serial_number","0090B0C0011132");
//                    content.put("type","1");

                    reqBodyone.put("content", content);
...
//                    reqBodyone.put("bits", bits);                // 音频采样点位数 非必填
            ...
            public void onMessage(String message) {
                ...
                if (jsonObject.containsKey("code") && jsonObject.getInteger("code") == 1000) {
                    ...
                    if (jsonObject.containsKey("is_end") && jsonObject.getBoolean("is_end") && !jsonObject.containsKey("sequence")) {
                        System.out.println(LocalDateTime.now().format(DateTimeFormatter.ofPattern("yyyy-MM-dd HH:mm.ss.SSS")) + " 【5】tts结果输出结束，输出内容为： " + stringBuilder.toString());
                        stringBuilder.setLength(0);
                    }
                }
            }
